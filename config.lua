...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    ['beds'] = {
        { coords = vector4(319.47, -580.55, 44.2, 163.77),    taken = false, model = 1631638868 },
        { coords = vector4(324.32, -582.44, 44.2, 161.3),  taken = false, model = 1631638868 },
        { coords = vector4(322.57, -587.72, 44.2, 345.12),   taken = false, model = 2117668672 },
        { coords = vector4(322.57, -587.72, 44.2, 345.12),    taken = false, model = 2117668672 },
        { coords = vector4(314.28, -584.76, 44.2, 345.79),   taken = false, model = 2117668672 },
        { coords = vector4(310.99, -583.43, 44.2, 342.62),  taken = false, model = -1091386327 },
        { coords = vector4(309.45, -576.83, 44.2, 156.28),  taken = false, model = -1091386327 },
        { coords = vector4(307.58, -582.21, 44.2, 339.61),  taken = false, model = -1091386327 },
        { coords = vector4(314.0, -578.65, 44.2, 167.83),  taken = false, model = -1091386327 },
        --- paleto
...
Config.Items = { -- Grade is key, don't add same item in multiple grades. Higher rank can see lower
    [0] = {
        ...
        { name = 'hospitalbedtable',        price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'medtable',                price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'medmachine',              price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'oscillator',              price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'microscope',              price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'hazardbin',               price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'examlight',               price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'medbag',                  price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'wheelchair',              price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'stretcher1',              price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'stretcher2',              price = 0, amount = 50, info = {}, type = 'item' },
